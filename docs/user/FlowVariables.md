...
| <a name="GUI_WNS"></a>GUI_WNS| Prune register and pin endpoints not appearing in the N first WNS paths in path groups and histogram buckets. This can be helpful for very large designs of millions of instances. Default, no pruning.| None|
