...
| <a name="SYNTH_ODB_TCL"></a>SYNTH_ODB_TCL| Specifies a Tcl script with commands to run as part of the synth ODB generation step.  Useful in bazel-orfs flows which can paralleled hierarchical synthesis and needs to clean up the final netlist.| |
