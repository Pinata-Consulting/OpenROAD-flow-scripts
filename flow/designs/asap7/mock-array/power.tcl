...
read_verilog results/asap7/mock-array_Element/base/5_1_grt.v
read_verilog $::env(RESULTS_DIR)/5_1_grt.v
read_verilog $::env(PLATFORM_DIR)/verilog/stdcell/empty.v

link_design MockArray

read_sdc $::env(RESULTS_DIR)/5_1_grt.sdc
read_spef $::env(RESULTS_DIR)/5_1_grt_default.spef
for {set x 0} {$x < 8} {incr x} {
  for {set y 0} {$y < 8} {incr y} {
    read_spef -path ces_${x}_${y} results/asap7/mock-array_Element/base/5_1_grt_default.spef
  }
}
